...
public:
    void bake() override {
        std::cout << "Baking New York cheese pizza." << std::endl;
    }
    void cut() override {
        std::cout << "Cutting New York style cheese pizza." << std::endl;
    }
    void box() override {
        std::cout << "Boxing New York cheese pizza." << std::endl;
    }
};
...
public:
    void bake() override {
        std::cout << "Baking New York pepperoni pizza." << std::endl;
    }
    void cut() override {
        std::cout << "Cutting New York pepperoni pizza." << std::endl;
    }
    void box() override {
        std::cout << "Boxing New York pepperoni pizza." << std::endl;
    }
};
...
public:
    ...
    void box() override {
        std::cout << "Boxing Chicago cheese pizza." << std::endl;
    }
};
...
public:
    void bake() override {
        std::cout << "Baking Chicago pepperoni pizza." << std::endl;
    }
    void cut() override {
        std::cout << "Cutting Chicago pepperoni pizza." << std::endl;
    }
    void box() override {
        std::cout << "Boxing Chicago pepperoni pizza." << std::endl;
    }
};
